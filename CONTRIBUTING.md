...
1. Keep pulling
   ...
   ```bash
   git remote add upstream https://github.com/bfenetworks/conf-agent
...
1. Push and file a pull request
   ...
   The push allows you to create a pull request, requesting owners of this [official repo](https://github.com/bfenetworks/conf-agent) to pull your change into the official one.
